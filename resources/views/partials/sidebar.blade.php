      ...
      <li class="dropdown">
        <a href="#" class="menu-toggle nav-link has-dropdown"><i
         ...
         <ul class="dropdown-menu">
          <li><a class="nav-link" href="widget-chart.html">Vue Global</a></li>
          <li><a class="nav-link" href="widget-data.html">Locations</a></li>
        </ul>
      </li>
    @endcan
      ...
      <li class="dropdown">
        <a href="#" class="menu-toggle nav-link has-dropdown"><i class="fas fa-cogs"></i><span>Gestion Articles</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link" href="email-inbox.html">Types Articles</a></li>
          <li><a class="nav-link" href="email-compose.html">Articles</a></li>
          <li><a class="nav-link" href="email-read.html">Tarifications</a></li>
        </ul>
        @endcan
      ...
      <li><a class="nav-link" href="blank.html"><i class="fas fa-users"></i><span>Gestion des clients</span></a></li>
      <li><a class="nav-link" href="blank.html"><i class="fas fa-exchange-alt"></i><span>Gestion des locations</span></a></li>

      <li class="menu-header">CAISSE</li>
      <li><a class="nav-link" href="blank.html"><i class="fas fa-coins"></i><span>Gestion des paiements</span></a></li>
      @endcan
      {{-- <li class="dropdown">
        <a href="#" class="menu-toggle nav-link has-dropdown"><i
